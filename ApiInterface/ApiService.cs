...
namespace ApiInterface
{
    public class ApiService : IApi
    {
        ...
        public Task<HotelList> GetHotelsByOwnerIdAsync(int ownerId)
        {
            return GetAsync<HotelList>($"api/Hotels/GetByOwnerId/{ownerId}");
        }
        ...
        // ===================== HotelImages =====================
        public Task<HotelImagesList> GetHotelImagesByHotelIdAsync(int hotelId)
            => GetAsync<HotelImagesList>($"api/HotelImages/ByHotel/{hotelId}");

        public Task<HotelImagesList> GetAllHotelImagesAsync()
            => GetAsync<HotelImagesList>("api/HotelImages/GetAll");

        public Task<HotelImage?> GetHotelImageByIdAsync(int id)
            => GetAsync<HotelImage?>($"api/HotelImages/GetById/{id}");

        public Task<int> InsertHotelImageAsync(HotelImage hi)
            => PostAsync("api/HotelImages/Insert", hi);

        public Task<int> UpdateHotelImageAsync(HotelImage hi)
            => PutAsync("api/HotelImages/Update", hi);

        public Task<int> DeleteHotelImageAsync(int id)
            => DeleteAsync($"api/HotelImages/Delete/{id}");
